            ...
            "elements": [
                {
                    "type": "html",
                    "name": "risk_info",
                    "html": "<div style=' border-radius: 25px; padding: 20px; background-image: linear-gradient(0deg,  rgb(231, 206, 61),rgb(211, 159, 16));width:75%; margin:auto;'><center><p style='margin:auto;'>Your risk is <h3>Slightly Elevated</h3>Compared to a healthy lifestyle</p></center></div>"
                },{
                    "type": "html",
                    "name": "risk_info",
                    "html": "<h3>Your risk is :</h3> <ul> <li><div> <p>Physical Activity: <span style='color: green;  font-weight: bold;' class='text-orientation-right-css'>Keep it up</span></p></div></li><li><div><p>Sugar drinks: <span style='color:red;  font-weight: bold;' class='text-orientation-right-css'>Need to cut out</span></p></div></li><li><div><p>Nuts: <span style='color:rgb(226, 212, 15); font-weight: bold;' class='text-orientation-right-css'>Could do better</span></p></div></li><li><div><p>Fruits: <span style='color: green;  font-weight: bold;' class='text-orientation-right-css'>Keep it up</span></p></div></li></ul>"
                },{
                    "type": "html",
                    "name": "recommendations",
                    "html": "<div style='display: flex; justify-content: space-around'><a href=''style='padding:13px 15px 13px 15px; background-color: rgba(47, 136, 236, 0.733); color: white; border-radius: 8px; font-size: medium;'>Read some recomendation</a></div>"
                }
            ]
        }
